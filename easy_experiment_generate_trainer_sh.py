...
# Configuration
# ==========================================
# Point this to your specific JSON file for the easy_classification experiment
json_file_path = "easy_classification/saved_results/best_learning_rates_selected_optimizers.json"
output_sh_file = "run_best_easy_class_local.sh"
...
with open(output_sh_file, 'w') as out_file:
    ...
    out_file.write("mkdir -p easy_classification/logs\n\n")
    
    out_file.write("echo 'Starting Initialization...'\n")
    out_file.write("python easy_classification/initialization.py\n\n")
    ...
    # Assuming your JSON structure matches the standard one:
    ...
    for config in configs:
        ...
        for seed in range(5):
            ...
            # Construct the python command exactly matching the easy_classification sbatch wrap commands
            cmd = (
                f"python easy_classification/trainer.py "
