...
# Note: Beta2 is fixed at 0.999 in the provided script
BETA2_VAL=0.999
...
for bs in "${BATCH_SIZES[@]}"; do
    for opt in "${OPTIMIZERS[@]}"; do
        for lr in "${LEARNING_RATES[@]}"; do
            ...
            json_name="${opt}_${BETA2_VAL}_${bs}_${SEED}_${lr}.json"
            
            echo "Running -> Opt: $opt | Beta2: $BETA2_VAL | Batch Size: $bs | LR: $lr"
...
echo "All MNIST HP sweep experiments finished successfully!"
