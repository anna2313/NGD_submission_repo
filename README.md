...
When cloning this repository, just create the environment following the environment.yml. 

For the MNIST experiments you will need the asdl package. We recommend copying over this packages asdl_master folder into the root folder. (https://github.com/kazukiosawa/asdl)

No other set-up is neccessary.
...
chmod +x "linearregexperiment_no_training.sh"
