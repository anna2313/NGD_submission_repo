...
mkdir -p sinexperiment/logs

# ==========================================
# 2. Initialization Step
# ==========================================
echo "Starting Initialization..."
python sinexperiment/initialization.py --regenerate_data --sigma 0.3
...
# Define hyperparameter grids based on this specific script
    ...
    for bs in "${BATCH_SIZES[@]}"; do
        for opt in "${OPTIMIZERS[@]}"; do
            for seed in "${SEEDS[@]}"; do
                ...
                python sinexperiment/trainer.py \
                    --optimizer_name "$opt" \
                    --beta1 0.9 \
                    --beta2 "$beta2" \
                    --batch_size "$bs" \
...
echo "All sine seed experiments finished successfully!"
